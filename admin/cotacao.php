...
<div id="main-body">
	...
	<div id="content">
			...
			<div class="linhaConfig" id="busca">  
				...
				<a href="javascript:doAjaxSemRetorno('ajax_com/compras.php?acao=adicionar&local=cotacao',1,'addPop');addPop_open(630);" class="button"><span>Incluir</span></a><br /><br />
				...
				<div id="buscaDiv" style="display:none;">
					<div class="form-group form-inline">
						...
						<a href="javascript:doAjaxSemRetorno('ajax_com/compras.php?acao=listarCotacao&fornecedores=' + $('fornecedoresBusca').value  + '&dataIni=' + $('dataIni').value + '&dataFim=' + $('dataFim').value + '&codigo=' + $('codigoBusca').value, 1, 'SaidaMain');" href="#">
