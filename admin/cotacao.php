	...
	<div id="content">
			...
			<div class="linhaConfig" id="busca">  
				<ul class="nav nav-tabs" role="tablist">
    				...
    				<li role="presentation" class=""><a href="#"  onclick="doAjaxSemRetorno('ajax_com/compras.php?acao=adicionar&local=cotacao',1,'addPop');addPop_open(630);" aria-controls="home" role="tab" data-toggle="tab">Cadastrar Novo</a></li>
    			</ul>
