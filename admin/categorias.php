...
$Main->DataGrid->setQuery("SELECT * from categorias ");
$Main->DataGrid->setTabela("categorias");
$Main->DataGrid->setColunas("categorias.id_categorias");
$Main->DataGrid->setColunas("categorias.nome.like");
$Main->DataGrid->setColunas("categorias.tipo.like");
...
<div id="main-body">
	<div class="title">
		<div class="row">
	  		<div class="col-md-10">
	  			<p class="titlePage" id="recent">Categorias</p>
			</div>
		</div>
	</div>
