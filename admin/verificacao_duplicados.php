...
$Main->DataGrid->setColunas("validacoes_duplicados.id_cadastros");
$Main->DataGrid->setColunas("validacoes_duplicados.id_campos");
...
<div id="main-body">
	<div class="title">
		<div class="row">
	  		<div class="col-md-10">
	  			<p class="titlePage" id="recent">Campos verificação duplicidade</p>
			</div>
		</div>
	</div>
	<div id="content">
