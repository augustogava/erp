...
$Main->DataGrid->setQuery("SELECT * from tipo_pagamentos ");
$Main->DataGrid->setTabela("tipo_pagamentos");
$Main->DataGrid->setColunas("tipo_pagamentos.id");
$Main->DataGrid->setColunas("tipo_pagamentos.nome.like");
