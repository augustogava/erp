...
$Main->DataGrid->setQuery("SELECT * from tipo_entrega ");
$Main->DataGrid->setTabela("tipo_entrega");
$Main->DataGrid->setColunas("tipo_entrega.id");
$Main->DataGrid->setColunas("tipo_entrega.nome.like");
...
<div id="main-body">
	<div class="title">
		<div class="row">
	  		<div class="col-md-10">
	  			<p class="titlePage" id="recent">Tipos de Entrega</p>
			</div>
		</div>
	</div>
	<div id="content">
