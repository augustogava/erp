...
$Main->DataGrid->setQuery("SELECT * from fornecedores ");
$Main->DataGrid->setTabela("fornecedores ");
$Main->DataGrid->setColunas("fornecedores.id");
$Main->DataGrid->setColunas("fornecedores.nome.like");
$Main->DataGrid->setColunas("fornecedores.telefone1.like");
...
<div id="main-body">
	<div class="title">
		<div class="row">
	  		<div class="col-md-10">
	  			<p class="titlePage" id="recent">Fornecedores</p>
			</div>
		</div>
	</div>
	<div id="content">
