...
<div id="main-body">
	<div class="title">
		<div class="row">
	  		<div class="col-md-10">
	  			<p class="titlePage" id="recent">Relatório Despesas</p>
			</div>
		</div>
	</div>
	<div id="content">
			...
			<button type="button" onClick="abrirRelatorioDespesas();" class="btn btn-success" style="margin-top: 0px">Gerar Relatório</button>
				
					<script>
						document.onkeypress = function (evt){
							if(main.procuraTecla(evt,13)){
								if(confirm('Deseja gerar o relat�rio?')){ abrirRelatorioDespesas() }
							}
						}
