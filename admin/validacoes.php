...
$Main->DataGrid->setQuery("SELECT * from validacoes ");
$Main->DataGrid->setTabela("validacoes");
$Main->DataGrid->setColunas("validacoes.id");
$Main->DataGrid->setColunas("validacoes.id_cadastros");
$Main->DataGrid->setColunas("validacoes.id_campos");
...
<div id="main-body">
	<div class="title">
		<div class="row">
	  		<div class="col-md-10">
	  			<p class="titlePage" id="recent">Validações</p>
			</div>
		</div>
	</div>
	<div id="content">
